 ...
 */
object CrossValidation2 extends Controller {
  ...
  def show = Action {
    implicit request =>
      ...
      Ok(views.html.form.crossValidation2(form))
    ...
    implicit request =>
      ...
      formInput.fold(
        ...
        success = { integers =>
          ...
          Redirect(routes.CrossValidation2.show).flashing(flashDataMap)
        })
  ...
  private def processError(formWithError: Form[Integers])(implicit request: Request[Any]): SimpleResult[Html] = {
    ...
    Ok(views.html.form.crossValidation2(formWithError2))
